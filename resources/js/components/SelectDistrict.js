...
Vue.component('select-district', {
    ...
    methods:{
        setFromValue(value) {
            ...
            const provinceId = loda.findKey(this.provinces, o => o === value[0]);
            // 没找到，清空省的值
            if (!provinceId) {
                this.provinceId = '';
                return;
            ...
            const cityId = loda.findKey(addressData[provinceId], o => o === value[1]);
            // 没找到，清空城市的值
            if (!cityId) {
                this.cityId = '';
                return;
            ...
            const districtId = loda.findKey(addressData[cityId], o => o === value[2]);
