                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        <div class="sales_and_reviews">
                            ...
                            <!-- floor函数向下舍入为最接近的整数。str_repeat函数把字符串重复指定的次数。 -->
                        ...
                        <div class="skus" >
                            ...
                            <div class="buttons">
                                <button class= " btn {{ $favored ? 'btn-danger btn-disfavor': 'btn-success btn-favor' }} "> 
                                    {{ $favored ? '取消收藏': '❤ 收藏' }}
                                </button>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.sku-btn').click(function () {
                    $('.product-info .product-price span').text($(this).data('price'));
